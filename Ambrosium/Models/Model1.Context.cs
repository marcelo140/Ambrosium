...
namespace Ambrosium.Models
{
    ...
    public partial class ambrosium_bdEntities : DbContext
    {
        public ambrosium_bdEntities()
            : base("name=ambrosium_bdEntities")
        {
        }
        ...
        public virtual DbSet<Sugestão> Sugestão { get; set; }
